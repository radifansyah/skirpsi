...
if (isset($_POST['login'])) {
	...
	if ($query->rowCount() > 0) {
		...
		echo "<script>alert('Pastikan Anda Masukkan Username Dan Password Dengan Benar');</script>";
	}
}
...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(../admin/img/a.jpg);">
