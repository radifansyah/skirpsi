...
<body>
  ...
  <!--Page Header-->
  <section class="page-header listing_page" style="background-image: url(assets/images/a.jpg);">
    <div class="container">
        ...
        <div class="col-md-9 col-md-push-3">
          <div class="result-sorting-wrapper">
            <div class="sorting-count">
              ...
              $sql = "SELECT id from tblproduk where tblproduk.Kategori=:brand";
          ...
          $sql = "SELECT tblproduk.*,tblkategori.namaKategori,tblkategori.id as bid  from tblproduk join tblkategori on tblkategori.id=tblproduk.Kategori where tblproduk.Kategori=:brand ";
          $query = $dbh->prepare($sql);
          $query->bindParam(':brand', $brand, PDO::PARAM_STR);
          // $query->bindParam(':fueltype', $fueltype, PDO::PARAM_STR);
          $query->execute();
