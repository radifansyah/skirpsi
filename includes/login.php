...
if (isset($_POST['login'])) {
  ...
  $sql = "SELECT Email,Password,Namalengkap FROM tbluser WHERE Email=:email and Password=:password";
  ...
  if ($query->rowCount() > 0) {
    ...
    echo "<script>alert('Masukkan Username Dan Password Anda Dengan Benar!!');</script>";
  }
}
