          ...
          <div class="container">
            <div class="user_profile_info gray-bg padding_4x4_40">
              ...
              <div class="dealer_info">
                ...
                <p><?php echo htmlentities($result->Email); ?><br>
                  <?php echo htmlentities($result->Notelpon); ?><br><?php echo htmlentities($result->Country);
                                                                  }
                                                                } ?></p>
              </div>
            </div>
            <div class="row">
              <div class="col-md-3 col-sm-3">
                  ...
                  <div class="profile_wrap">
                    ...
                    <div class="my_vehicles_list">
                      <ul class="vehicle_listing">
                        <?php
                        $useremail = $_SESSION['login'];
                        $sql = "SELECT tblproduk.Vimage1 as Vimage1,tblproduk.Namaproduk,tblproduk.id as vid,tblkategori.namaKategori,tblbooking.Daritanggal,tblbooking.Sampaitanggal,tblbooking.Pesan,tblbooking.Status  from tblbooking join tblproduk on tblbooking.Barang=tblproduk.id join tblkategori on tblkategori.id=tblproduk.Kategori where tblbooking.Emailid=:useremail";
                        $query = $dbh->prepare($sql);
                        $query->bindParam(':useremail', $useremail, PDO::PARAM_STR);
                        $query->execute();
                        $results = $query->fetchAll(PDO::FETCH_OBJ);
                ...
                <div class=" vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Di Konfirmasi</a>
                                    <div class="clearfix"></div>
                              </div>

                            <?php } else if ($result->Status == 2) { ?>
                              <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Di Batalkan</a>
                                <div class="clearfix"></div>
                              </div>
                            ...
                            <?php } else { ?>
                              ...
                              <div class="vehicle_status"> <a href="#" class="btn outline btn-xs" style="font-size: 9px;">Belum di Konfirmasi</a>
                                <div class="clearfix"></div>
                              </div>
                            <?php } ?>
