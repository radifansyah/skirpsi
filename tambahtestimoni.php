...
if (strlen($_SESSION['login']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    $testimonoial = $_POST['testimoni'];
    $email = $_SESSION['login'];
    $sql = "INSERT INTO  tbltestimonial(Email,Testimoni) VALUES(:email,:testimonoial)";
            ...
            <div class="user_profile_info gray-bg padding_4x4_40">
              ...
              <div class="dealer_info">
                ...
                <p><?php echo htmlentities($result->Email); ?><br>
                  <?php echo htmlentities($result->Notelpon); ?>&nbsp;<?php echo htmlentities($result->Country);
                                                                    }
                                                                  } ?></p>
              </div>
            </div>
                  ...
                  <div class="profile_wrap">
                    ...
                    <form method="post">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control white_bg" name="testimoni" rows="4" required=""></textarea>
                      </div>
